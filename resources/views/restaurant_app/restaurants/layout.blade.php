		...
		<div class="x_content">
			<ul class="nav nav-tabs bar_tabs" role="tablist">
                ...
                <li class="{{ isset($employee_active)? 'active' : '' }} dropdown">
                	<a href="{{ route('res.employees.index',[session('workspace')->url,$restaurant->id]) }}">
                        <i class="fa fa-users"></i> Nhân viên
                        <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="{{ route('res.employees.index',[session('workspace')->url,$restaurant->id]) }}">Danh sách nhân viên</a></li>
                        <li><a href="{{ route('res.employees.create',[session('workspace')->url,$restaurant->id]) }}">Thêm mới</a></li>
                    </ul>
                </li>
                ...
                <li class="{{ isset($info_active)? 'active' : '' }}">
                	<a href="{{ route('restaurants.edit',[session('workspace')->url,$restaurant->id]) }}">
