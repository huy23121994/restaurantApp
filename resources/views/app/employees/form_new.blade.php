		...
		<div class="col-sm-4 col-xs-12">
		  <div class="form-group">
		    ...
		    <div class="text-center m_t_10">
		    	<label for="avatar"><img src="/img/user.png" class="img-thumbnail" width="180" height="180"></label>
		    </div>
		    <input type="file" id="avatar" name="avatar" class="m_t_10">
		  </div>
		</div>
	      ...
	      <div class="form-group">
            ...
            <div class="controls">
              <div class="xdisplay_inputx form-group has-feedback">
	              <input type="text" class="form-control has-feedback-left daterangepicker" id="birthday" name="birthday" placeholder="01/01/1994" data-inputmask="99/99/9999">
